...
export default function Footer() {
  ...
  return (
<footer className="bg-[#064E3B] text-white w-full py-10 px-4">
  <div className="max-w-7xl mx-auto">
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-20 max-w-7xl mx-auto">
      ...
      <div>
        ...
        <p className="text-[#FFFFFF] text-center lg:text-left">
      ...
      <div className="lg:w-[500px]">
        <h4 className="font-semibold mb-10 text-center text-lg">Servicio</h4>
        <div className="grid grid-cols-2 gap-x-10 text-[#FFFFFF]">
      ...
      {/* Contacto */}
      <div>
        <h4 className="font-semibold mb-10 px-12 text-center text-lg">Contacto</h4>
        <ul className="px-12 space-y-3 text-[#FFFFFF] text-center lg:text-right">
    ...
    {/* Línea divisoria */}
    <div className="border-t border-[#16813e] mt-12 pt-6 text-center text-[#FFFFFF]">
