      ...
      <section className="py-16 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            Transformamos tus espacios verdes con servicios profesionales de
            jardinería. Desde el diseño hasta el mantenimiento, cuidamos cada
            detalle de tu jardín.
          </p>
        ...
        <div className="container mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Contamos con un equipo de expertos en jardinería listos para hacer
              realidad tus proyectos verdes
            </p>
          </div>
